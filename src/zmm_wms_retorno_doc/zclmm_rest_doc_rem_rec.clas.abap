CLASS zclmm_rest_doc_rem_rec DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zclmm_rest_doc_rem_rec IMPLEMENTATION.
...
***************************************************************************
    ...
    CONCATENATE 'ZCLMM_REST_DOC_REM_REC_' lv_request_method INTO lv_class_name.
