CLASS zclmm_exec_processo DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zclmm_exec_processo IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA: lt_tab                   TYPE TABLE OF zc_mm_wms_exec_processo_ce,
...
*              DATA(lv_salesorder)     =   VALUE #( lt_parameters[ parameter_name =  'P_HANDLINGUNITEXTERNALID' ]-value OPTIONAL ).
              "Cria instancia
              DATA(lo_controller) = zclmm_exec_processo_imp=>get_instance( ).
