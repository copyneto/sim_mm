class ZCLMM_REST_SALD_EST_MOV_POST definition
  public
  final
  create public .
...
CLASS ZCLMM_REST_SALD_EST_MOV_POST IMPLEMENTATION.
...
***************************************************************************
    DATA:
      lt_tab_cpi       TYPE TABLE OF zsmm_sald_est_mov,
      ...
      ls_struc_cpi     TYPE zsmm_sald_est_mov,
...
***************************************************************************
    ...
    NEW zclca_monitor_cpi(  )->started_process(
             EXPORTING
                  iv_metodo = 'POST'
                  iv_processo = 'ZMM_SALDO_ESTOQUE_MOV_WMS'
...
***************************************************************************
    ...
    DATA(lt_return) = NEW zclmm_sald_est_mov( is_sald_est_mov = ls_struc_cpi  )->process(  ).
